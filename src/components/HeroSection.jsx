        ...
        <div className="text-center">
          ...
          <div className="max-w-lg flex mx-auto relative mb-12">
            ...
            <input
              ...
              value={searchTerm} // <--- Context se li hui searchTerm value
              onChange={(e) => handleSearch(e.target.value)} // <--- Context ka handleSearch function call karein
              className=" pl-12 pr-4 py-4 h-12 w-96 md:w-[100%] text-lg rounded-2xl border-2 border-gray-200 focus:border-blue-500 shadow-lg"
            />
          </div>
