  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Calculate percentages or find what percent one number is of another."
        />
        <link
          rel="canonical"
          href={`${DOMAIN}/math/percentage-calculator`}
        />
        <meta
          property="og:title"
          content="Percentage Calculator - CalPro"
        />
        <meta
          property="og:description"
          content="Easily calculate Percentage in one step."
        />
      </Helmet>
      ...
      <div className="flex flex-col items-center pb-4 w-full">
        <div className="self-start mb-4">
          ...
          <p className="text-md text-gray-600 pt-2 pb-2 md:pb-7">
            Use this calculator to find a percentage of a value or what percent
        ...
        <div className="w-full max-w-xl p-8 bg-white/80 backdrop-blur-md shadow-xl rounded-3xl border border-gray-200">
          ...
          <button
            ...
            className="w-full mt-6 bg-gradient-to-r from-yellow-400 to-yellow-600 text-white font-semibold py-3 rounded-lg hover:opacity-90 transition duration-300 hover:cursor-pointer"
          >
            🔍 Calculate
          </button>
          ...
          {result !== null && (
            <div className="mt-8 text-center text-gray-700">
              <p className="text-xl font-semibold">
                ✅ Result: <span className="text-yellow-600">{result}</span>
              </p>
            </div>
          )}
        </div>
