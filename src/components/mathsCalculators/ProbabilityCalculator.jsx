  ...
  return (
    <>
      <Helmet>
        ...
        <link
          rel="canonical"
          href={`${DOMAIN}/math/probability-calculator`}
        />
        <meta
          property="og:title"
          content="Probability Calculator - CalPro"
        />
        <meta
          property="og:description"
          content="Easily calculate probability."
        />
      </Helmet>
      ...
      <div className="flex flex-col items-center pb-4 w-full">
        <div className="self-start mb-4">
          ...
          <p className="text-md text-gray-600 pt-2 pb-2 md:pb-7">
            Find the likelihood of an event happening using favorable and total
            outcomes.
          </p>
        </div>
        ...
        <div className="w-full max-w-xl p-8 bg-white/80 backdrop-blur-md shadow-xl rounded-3xl border border-gray-200">
          ...
          <button
            ...
            className="w-full mt-6 bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-semibold py-3 rounded-lg hover:opacity-90 transition duration-300 hover:cursor-pointer"
          >
              ...
              {result.error ? (
                ...
                <>
                  ...
                  <p className="text-sm text-gray-500">
                    (or {(result.probability * 100).toFixed(2)}%)
                  </p>
                </>
              )}
            </div>
        ...
        <div className="pt-10">
          <p className="text-sm text-gray-600">
            This calculator computes the probability of an event occurring using
            the formula:
            <strong> P(E) = Favorable Outcomes / Total Outcomes</strong>. It's
            ideal for basic probability problems in statistics and mathematics.
          </p>
        </div>
      </div>
    </>
