...
const AreaAndPerimeter = () => {
  ...
  const [inputs, setInputs] = useState({ length: "", width: "", side: "", radius: "" });
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Calculate area and perimeter for rectangles, squares, and circles." />
        <link rel="canonical" href="https://yourdomain.com/math/area-perimeter" />
      </Helmet>

      <div className="flex flex-col items-center pb-4 w-full">
        <div className="self-start mb-4">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800">Area & Perimeter Calculator</h2>
        ...
        <div className="w-full max-w-xl p-8 bg-white/80 backdrop-blur-md shadow-xl rounded-3xl border border-gray-200">
          <div className="flex justify-center gap-2 mb-6">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-gray-800">Select Shape</h2>
          </div>
            ...
            {[
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg border text-sm font-medium ${
                  shape === value ? "bg-blue-600 text-white" : "bg-white text-gray-700"
                }`}
              >
                {label}
              </button>
          ...
          {result && (
            <div className="mt-8 text-center text-gray-700">
              <p className="text-lg">✅ Area: <span className="font-semibold">{result.area}</span></p>
              <p className="text-lg">📐 Perimeter: <span className="font-semibold">{result.perimeter}</span></p>
            </div>
          )}
        ...
        <div className="pt-10">
            <p className="text-sm text-gray-600">
              Use this tool to calculate the area and perimeter of common shapes: rectangles,
              squares, and circles. Just input the required dimensions and get instant results
