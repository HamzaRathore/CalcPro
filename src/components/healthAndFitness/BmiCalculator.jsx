  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Calculate your Body Mass Index using CalPro's BMI calculator."
        />
        <link
          rel="canonical"
          href={`${DOMAIN}/health/bmi-calculator`}
        />
        <meta property="og:title" content="BMI Calculator - CalPro" />
        <meta
          property="og:description"
          content="Check your body weight category using BMI formula."
        />
      </Helmet>
      ...
      <div className="flex flex-col items-center pb-4 w-full">
        <div className="self-start mb-4">
          ...
          <p className="text-md text-gray-600 pt-2 pb-2 md:pb-7">
            Find out if you're underweight, healthy, overweight, or obese.
          </p>
        </div>
        ...
        <div className="pt-10">
          <p className="text-sm text-gray-600">
            ...
            height and weight. The result can help indicate whether you are
