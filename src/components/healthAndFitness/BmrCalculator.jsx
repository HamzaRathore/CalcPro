  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Calculate your Basal Metabolic Rate with CalPro's BMR calculator." />
        <link rel="canonical" href="https://yourdomain.com/health/bmr-calculator" />
        <meta property="og:title" content="BMR Calculator - CalPro" />
        <meta property="og:description" content="Estimate how many calories your body needs to function at rest." />
      </Helmet>

      <div className="flex flex-col items-center pb-4 w-full">
        <div className="self-start mb-4">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800">BMR Calculator</h2>
          <p className="text-md text-gray-600 pt-2 pb-2 md:pb-7">Estimate your Basal Metabolic Rate and daily calorie needs.</p>
        </div>
        <div className="w-full max-w-xl p-8 bg-white/80 backdrop-blur-md shadow-xl rounded-3xl border border-gray-200">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-gray-800">BMR Calculator</h2>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select value={gender} onChange={(e) => setGender(e.target.value)} className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none transition">
          ...
          {bmr && (
            <div className="mt-8 text-center space-y-2">
              ...
              <p className="text-3xl md:text-4xl font-extrabold text-red-600">{bmr} Calories/day</p>
            </div>
          )}
        </div>
        <div className="pt-10">
          <p className="text-sm text-gray-600">Basal Metabolic Rate (BMR) represents the number of calories your body needs to perform essential life-sustaining functions such as breathing, blood circulation, cell production, and digestion while at complete rest. This calculator helps you estimate your BMR based on factors like age, gender, weight, and height, giving you a clearer understanding of how much energy your body requires daily. Knowing your BMR is especially useful for setting accurate calorie intake goals for weight loss, maintenance, or muscle gain, and is a foundational tool for building effective nutrition and fitness plans.</p>
        </div>
      </div>
    </>
  );
